 ...
 * @author Miriam Lopez
 */
@WebServlet(name = "ReporteProductoProveedor", urlPatterns = {"/reporteProductoProveedor"})
public class ReporteProductoProveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int prov=Integer.parseInt(request.getParameter("codProv"));
            VariablesConexion conexion=new VariablesConexion();
            conexion.inicioConexion();
            File reportFile=new File(request.getServletContext().getRealPath("jasper/reporteProductoProveedor.jasper"));
