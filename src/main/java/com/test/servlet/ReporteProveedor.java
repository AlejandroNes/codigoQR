 ...
 * @author Miriam Lopez
 */
@WebServlet(name = "ReporteProveedor", urlPatterns = {"/reporteProveedor"})
public class ReporteProveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File reportFile=new File(request.getServletContext().getRealPath("jasper/reporteProveedor.jasper"));
