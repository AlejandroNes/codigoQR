...
public class CategoriaBean {
    ...
    public CategoriaBean() throws SQLException {
        ...
        System.out.println("INCICIANDO CONEXIO KEL----------------------------------------");
    }
    ...
    public String registrarCategoria(HttpServletRequest request) {
        String mensaje = "";
        if (request == null) {
            return "no envio nada";
        }
        if (connection != null) {
            try {
                //definiendo la consulta
                StringBuilder query = new StringBuilder();
                query.append(" insert into categoria (nom_cat,des_cat)");
                query.append(" values (?,?)");
    ...
    public void buscarCategoria(String codCategoria) {
        ...
        try {
//            pst = prepare statement=preparar la consulta
            PreparedStatement pst = connection.prepareStatement(query.toString());
            //le pasamos parametros a la variable pst
